...
public class PriceTagCheckDeleteRepository extends BaseRepository<String, Boolean> {
    ...
    /**
     * Check deleted status of price tag
     *
    ...
    protected Boolean doExecute(String priceTagSlug) {
        final String hqlQuery = "FROM PriceTagEntity P WHERE P.slug = :priceTagSlug AND P.isDeleted IS NOT NULL";
