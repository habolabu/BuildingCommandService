...
public class ApartmentCheckExistBySlugRepository extends BaseRepository<String, Boolean> {
    ...
    /**
     * Check apartment exist or not by slug
     *
     * @param apartmentSlug slug of apartment
     * @return exist or not
     * @author Nguyen Trung Kien - OU
    ...
    protected Boolean doExecute(String apartmentSlug) {
        final String hqlQuery = "FROM ApartmentEntity A WHERE A.slug = :apartmentSlug AND A.isDeleted IS NULL";
