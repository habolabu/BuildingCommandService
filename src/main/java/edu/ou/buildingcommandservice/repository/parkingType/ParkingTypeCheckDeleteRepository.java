...
public class ParkingTypeCheckDeleteRepository extends BaseRepository<String, Boolean> {
    ...
    /**
     * Check deleted status of parking type
     *
     * @param parkingTypeSlug slug of parking type
    ...
    protected Boolean doExecute(String parkingTypeSlug) {
        final String hqlQuery = "FROM ParkingTypeEntity P WHERE P.slug = :parkingTypeSlug AND P.isDeleted IS NOT NULL";
