...
public class RoomFindBySlugWithDeletedRepository extends BaseRepository<String, RoomEntity> {
    ...
    protected RoomEntity doExecute(String roomSlug) {
        final String hqlQuery = "FROM RoomEntity R WHERE R.slug = :roomSlug";
