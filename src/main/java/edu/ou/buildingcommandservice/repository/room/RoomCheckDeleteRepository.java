...
public class RoomCheckDeleteRepository extends BaseRepository<String, Boolean> {
    ...
    /**
     * Check deleted status of room
     *
     * @param roomSlug room slug
     * @return room delete status
     * @author Nguyen Trung Kien - OU
     */
    @Override
    protected Boolean doExecute(String roomSlug) {
        final String hqlQuery = "FROM RoomEntity R WHERE R.slug = :roomSlug AND R.isDeleted IS NOT NULL";
